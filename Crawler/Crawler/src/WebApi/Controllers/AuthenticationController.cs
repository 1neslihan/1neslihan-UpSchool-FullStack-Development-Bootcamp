...
namespace WebApi.Controllers
{
    ...
    public class AuthenticationController : ApiControllerBase
    {
        ...
        private const string REDIRECT_URI = "https://localhost:7090/api/Authentication/GoogleSignIn";
        ...
        public async Task<IActionResult> GoogleSignInAsync(string code, CancellationToken cancellationToken)
        {
            ...
            var jwtDto = await _authenticationService.SocialLoginAsync(userEMail, firstName, lastName, cancellationToken);
